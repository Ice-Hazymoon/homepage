 ...
 * -----
 * Last Modified: Tuesday, 26th June 2018 6:05:29 pm
...
export default {
    ...
    methods: {
        ...
        search(e){
            window.open('https://imiku.me/?s='+e.target.value);
        }
    }
}
</script>
